      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12 text-left">
          <div className="space-y-3">
            ...
            <p className="text-slate-300 text-xs leading-relaxed font-sans mt-3">
            ...
            <div className="pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 text-xs font-semibold text-accent hover:text-white transition-colors bg-white/10 border border-white/20 px-3 py-1.5 rounded-xl"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-300 font-sans">
              ...
              <li>
                <a href="/digital-h/" className="hover:text-accent transition-colors flex items-center gap-1.5 text-slate-300">
                  <span>• DIGITAL-H (Madurez Digital)</span>
                  <ExternalLink className="w-3 h-3 text-slate-400" />
                </a>
              </li>
              <li>
                <a href="/pulso-h/" className="hover:text-accent transition-colors flex items-center gap-1.5 text-slate-300">
                  <span>• PULSO-H (Riesgo Psicosocial)</span>
                  <ExternalLink className="w-3 h-3 text-slate-400" />
                </a>
              </li>
              <li>
                <a href="https://acrux.life/metodologia" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors flex items-center gap-1.5 text-slate-300">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-300 font-sans">
              ...
              <li className="text-slate-400 pt-1 text-[11px]">Habeas Data Ley 1581</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-slate-200 font-sans">
              <li className="flex items-center gap-2 bg-white/10 border border-white/20 p-2.5 rounded-xl">
                ...
                <span className="text-slate-200">Datos 100% Encriptados (SSL)</span>
              </li>
              <li className="flex items-center gap-2 bg-white/10 border border-white/20 p-2.5 rounded-xl">
                <Lock className="w-4 h-4 text-accent flex-shrink-0" />
                <span className="text-slate-200">Uso Estrictamente Confidencial</span>
              </li>
              <li className="flex items-center gap-2 bg-white/10 border border-white/20 p-2.5 rounded-xl">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 flex-shrink-0" />
                <span className="text-slate-200">Validado en 50+ Organizaciones</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-300 font-sans text-center md:text-left">
          <p className="text-slate-300 font-medium">© {new Date().getFullYear()} ACRUX Consultores S.A.S. Todos los derechos reservados.</p>
          <p className="text-accent font-mono text-[11px] bg-white/10 px-3 py-1 rounded-full border border-white/20 font-bold">
